(function($) {
    function CardJs(elem) {
        ...
        this.captureInstallments = this.elem.data("capture-installments") ? this.elem.data("capture-installments") : !1,
        ...
        this.initCvcInput(),
        this.initInstallmentsInput(),
        this.elem.empty(),
        this.setupCardNumberInput(),
        this.setupNameInput(),
        this.setupExpiryInput(),
        this.setupCvcInput(),
        this.setupInstallmentsInput(),
    ...
    ,
    CardJs.prototype.initInstallmentsInput = function() {
        if (this.captureInstallments) {
            this.installmentsInput = CardJs.detachOrCreateElement(this.elem, ".installments", "<select class='installments-select' />"),
            CardJs.elementHasAttribute(this.installmentsInput, "name") || this.installmentsInput.attr("name", "card-installments");
        }
    }
    ,
    ...
    ,
    CardJs.prototype.setupInstallmentsInput = function() {
        if (this.captureInstallments) {
            this.elem.append("<div class='installments-wrapper'><p>"+woocommerce_wompi_payments_cardjs.installments_title+"</p></div>");
            var wrapper = this.elem.find(".installments-wrapper");
            wrapper.append(this.installmentsInput);
            var installments_select = this.elem.find(".installments-select");
            installments_select.append("<option value='1' selected=''>1</option>");
            installments_select.append("<option value='2' >2</option>");
            installments_select.append("<option value='3' >3</option>");
            installments_select.append("<option value='6' >6</option>");
            installments_select.append("<option value='12' >12</option>");
            installments_select.append("<option value='18' >18</option>");
            installments_select.append("<option value='24' >24</option>");
            installments_select.append("<option value='36' >36</option>");
        }
    }
    ,
    ...
    CardJs.prototype.setupExpiryInput = function() {
        ...
        if (this.EXPIRY_USE_DROPDOWNS) {
            ...
            // this.expiryMonthYearInput.attr("autocomplete", "off"),
